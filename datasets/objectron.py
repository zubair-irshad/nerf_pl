...
class ObjectronDataset(Dataset):
    ...
    def read_meta(self):
        ...
        self.base_dir = '/home/zubair/nerf_pl/Objectron_data/camera/batch-11_40'
        ...
        self.all_c2w, self.focal = make_poses_bounds_array(frame_data, near=0.2, far=10)
        self.meta = sorted(glob.glob(self.base_dir+'/images/*.png'))
        
        self.focal *= self.img_wh[1]/1920
        w, h = self.img_wh
