...
class PDMultiObject(Dataset):
    ...
    def read_meta(self):
        ...
        if self.split == 'train':
            all_c2w, all_c2w_val, self.focal, self.img_size, _, _ = read_poses(pose_dir_train, img_files_train, output_boxes=True)
            ...
            _, _, self.focal, self.img_size, _, poses_scale_factor = read_poses(pose_dir_train, img_files_train, output_boxes=True)
